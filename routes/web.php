...
Route::group(['prefix' => LaravelLocalization::setLocale(),
    ...
    Route::group(['prefix' => 'quotes', 'middleware' => ['auth', 'verified', 'has.role', 'check.factory', 'check.task.status']], function () {
        ...
        Route::post('/{quoteId}/lines/json/import-cad', 'App\Http\Controllers\Workflow\QuoteLinesController@importCadJson')->name('quotes.lines.json.import-cad');
    ...
    Route::group(['prefix' => 'orders', 'middleware' => ['auth', 'verified', 'has.role', 'check.factory', 'check.task.status']], function () {
        ...
        Route::post('/{orderId}/lines/json/import-cad',                 'App\Http\Controllers\Workflow\OrderLinesController@importCadJson')->name('orders.lines.json.import-cad');
        //import
    ...
    Route::group(['prefix' => 'nesting', 'middleware' => ['auth', 'verified', 'has.role', 'check.factory']], function () {
        ...
        Route::get('/engine/status/{jobId}', 'App\Http\Controllers\Planning\NestingController@engineStatus')->name('nesting.engine.status');
        Route::get('/engine/preview/{jobId}/{sheet}', 'App\Http\Controllers\Planning\NestingController@enginePreview')->name('nesting.engine.preview');
        Route::get('/engine/download/{jobId}/{sheet}', 'App\Http\Controllers\Planning\NestingController@engineDownload')->name('nesting.engine.download');
    });
