    ...
    public function index()
    {
        ...
        $reactProps = [
            ...
            'urls' => [
                ...
                'deliveries_show' => route('deliverys') . '/',
                'invoices'        => route('invoices'),
                'invoices_show'   => route('invoices') . '/',
                'purchases'       => route('purchases'),
                'purchases_show'  => route('purchases') . '/',
            ...
            'endpoints' => [
                ...
                'recent_invoices'    => route('kpi.recent.invoices'),
                'recent_deliveries'  => route('kpi.recent.deliveries'),
                'recent_purchases'   => route('kpi.recent.purchases'),
                'top_clients'        => route('kpi.top.clients'),
