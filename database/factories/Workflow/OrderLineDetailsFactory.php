...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\OrderLineDetails>
 */
class OrderLineDetailsFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        ...
        return [
            'order_lines_id' => OrderLines::factory(),
            'x_size' =>$this->x_size,
            'y_size' => $this->y_size, 
            'z_size' => $this->z_size, 
