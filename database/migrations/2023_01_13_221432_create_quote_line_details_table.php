...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('quote_line_details', function (Blueprint $table) {
            $table->id();
            $table->integer('quote_lines_id');
			...
			$table->text('external_comment', 65535)->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('quote_line_details');
    }
};
