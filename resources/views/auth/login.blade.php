...
@if (config('adminlte.use_route_url', false))
    @php( $login_url = $login_url ? route($login_url, [], false) : '' )
    @php( $register_url = $register_url ? route($register_url, [], false) : '' )
    @php( $password_reset_url = $password_reset_url ? route($password_reset_url, [], false) : '' )
@else
...
@section('auth_body')
    <form action="{{ route('login.store', [], false) }}" method="post">
        @csrf
        @if (session('message'))
