                ...
                <div class="col-12">
                    ...
                    <div class="row invoice-info">
                        ...
                        <x-HeaderPrint  
                            ...
                            companieLabel="{{ optional($Document->companie)['label'] }}"
                            companieCivility="{{ optional($Document->contact)['civility'] }}"
                            companieFirstName="{{ optional($Document->contact)['first_name'] }}"
                            companieName="{{ optional($Document->contact)['name'] }}"
                            companieAdress="{{ optional($Document->adresse)['adress'] }}"
                            companieZipcode="{{ optional($Document->adresse)['zipcode'] }}"
                            companieCity="{{ optional($Document->adresse)['city'] }}"
                            companieCountry="{{ optional($Document->adresse)['country'] }}"
                            companieNumber="{{ optional($Document->contact)['number'] }}"
                            companieMail="{{ optional($Document->contact)['mail'] }}"
