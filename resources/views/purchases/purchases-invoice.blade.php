...
@section('title', __('general_content.purchase_invoice_info_trans_key'))

@section('content_header')
  <h1>{{ __('general_content.purchase_invoice_info_trans_key') }}</h1>
@stop

@section('content')
<div
  id="purchase-invoices-index-app"
