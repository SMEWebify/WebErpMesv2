        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <a href="{{ route('order.print', ['id' => $Purchase->id])}}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i>Print purchase order</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12 table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                  ...
                  <tr>
                    <td>
                      <a class="btn btn-primary btn-sm" href="{{ route('order.show', ['id' => $PurchaseLine->tasks->OrderLines->orders_id ])}}">
                          <i class="fas fa-folder"></i>
                          {{ $PurchaseLine->tasks->OrderLines->order->code }}
                      </a>
                    </td>
