...
<head>
    ...
    @if(config('branding.commercial'))
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset($faviconDir.'/favicon.ico') }}" />
    ...
    @elseif(config('adminlte.use_full_favicon'))
        <link rel="shortcut icon" href="{{ asset($faviconDir.'/favicon.ico') }}" />
        <link rel="apple-touch-icon" sizes="57x57" href="{{ asset($faviconDir.'/apple-icon-57x57.png') }}">
        <link rel="apple-touch-icon" sizes="60x60" href="{{ asset($faviconDir.'/apple-icon-60x60.png') }}">
        <link rel="apple-touch-icon" sizes="72x72" href="{{ asset($faviconDir.'/apple-icon-72x72.png') }}">
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset($faviconDir.'/apple-icon-76x76.png') }}">
        <link rel="apple-touch-icon" sizes="114x114" href="{{ asset($faviconDir.'/apple-icon-114x114.png') }}">
        <link rel="apple-touch-icon" sizes="120x120" href="{{ asset($faviconDir.'/apple-icon-120x120.png') }}">
        <link rel="apple-touch-icon" sizes="144x144" href="{{ asset($faviconDir.'/apple-icon-144x144.png') }}">
        <link rel="apple-touch-icon" sizes="152x152" href="{{ asset($faviconDir.'/apple-icon-152x152.png') }}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset($faviconDir.'/apple-icon-180x180.png') }}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{ asset($faviconDir.'/favicon-16x16.png') }}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset($faviconDir.'/favicon-32x32.png') }}">
        <link rel="icon" type="image/png" sizes="96x96" href="{{ asset($faviconDir.'/favicon-96x96.png') }}">
        <link rel="icon" type="image/png" sizes="192x192"  href="{{ asset($faviconDir.'/android-icon-192x192.png') }}">
        <link rel="manifest" crossorigin="use-credentials" href="{{ asset($faviconDir.'/manifest.json') }}">
        <meta name="msapplication-TileColor" content="#ffffff">
        <meta name="msapplication-TileImage" content="{{ asset($faviconDir.'/ms-icon-144x144.png') }}">
    @endif
