                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-8">
                              ...
                              <x-adminlte-input-switch id="type_update{{ $QualityAction->id }}" name="type_update" data-on-text="{{ __('general_content.internal_trans_key') }}" data-off-text="{{ __('general_content.external_trans_key') }}" data-on-color="teal" checked/>
                              @else
