                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="label" name="label"  id="label" placeholder="{{ __('general_content.name_order_trans_key') }}" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="customer_reference"  name="customer_reference"  id="customer_reference" placeholder="{{ __('general_content.customer_reference_trans_key') }}" @if($type == 2) disabled @endif>
